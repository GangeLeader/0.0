...
def arbab_ali():
    ...
    if username =="Arbab":
        ...
        if passwordss =="Memon":
            ...
            os.system("clear")
            print logo 
            print ("\033[1;92m[✓]\033[1;91m Username : Arbab\033[1;92m (Correct)")
            print ("\033[1;92m[✓]\033[1;91m Password : Memon\033[1;92m (Correct)")
            time.sleep(1)
            print('')
            abm("\033[1;97m[✓] Login Successful\033[0;97m")
            time.sleep(1)
        try:
            open(".login.txt","r")
            menu()
...
def login_choice():
    ...
    print ("\033[1;97m[1]\033[1;91m-⋄-\033[1;97mHACK THE ACCOUNT\033[1;97m(\033[1;92mlogin\033[1;97m) ")
    print ("\033[1;97m[0]\033[1;91m-⋄-\033[1;97mEXIT BOLE TO DAFA") 
    print("\033[1;97m--------------------------------------------------")
    clone_main()
def clone_main():
    hack = raw_input("\n╰─➣ ")
...
def menu():
    ...
    try:
        ...
        os.system("clear")
        print logo
        print("\033[1;91m[!] Loading Failed . Your Accoun has Cp")
        os.system("rm -rf .login.txt")
        time.sleep(1)
        login_choice()
    os.system('clear')
    ...
    print("\033[1;97m--------------------------------------------------")
    print("\033[1;97m[1]\033[1;91m-⋄-\033[1;93mClone Frienlist and Public ID")
    
    
    
    
    print("\033[1;97m[2]\033[1;91m-⋄-\033[1;93mTool Update")
